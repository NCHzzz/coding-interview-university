...
source: ../../README.md#balanced-search-trees
---

# 31.21 - Balanced search trees
...
## Balanced search trees
    ...
    - **Red/black trees**
        ...
        - In practice:
            ...
            the Completely Fair Scheduler used in current Linux kernels uses redâ€“black trees. In version 8 of Java,
    ...
    - **2-3-4 Trees (aka 2-4 trees)**
        - In practice:
            For every 2-4 trees, there are corresponding redâ€“black trees with data elements in the same order. The insertion and deletion
